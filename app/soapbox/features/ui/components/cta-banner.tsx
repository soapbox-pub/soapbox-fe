...
const CtaBanner = () => {
  ...
  return (
    <div data-testid='cta-banner' className='hidden lg:block fixed bottom-0 left-0 right-0 py-4 backdrop-blur bg-primary-800/80 dark:bg-primary-900/80 z-50'>
        ...
        <div className='col-span-9 col-start-4 xl:col-start-4 xl:col-span-6 md:px-8'>
          <HStack alignItems='center' justifyContent='between'>
            <Stack space={1}>
              ...
              <Text theme='white' weight='medium' className='opacity-80'>
